...
module.exports = class Handler {
	constructor() {
		...
		this.tables = {
			users: 'jspsych6_users',
			stim: 'jspsych6_stimuli',
			stimResp: 'jspsych6_stimulusResponses',
			stimGroups: 'jspsych6_stimulusGroups',
			stimGroupStim: 'jspsych6_stimulusGroupStimuli',
			TUQ: 'jspsych6_TUQ',
			TUQSR: 'jspsych6_TUQSR',
		};
