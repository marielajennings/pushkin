...
module.exports = (rpc, conn) => {
	...
	const task_queue = 'jspsych6_quiz_taskworker'; // for stuff that'll need ML, etc.
	const db_read_queue = 'jspsych6_quiz_dbread'; // simple endpoints
	const db_write_queue = 'jspsych6_quiz_dbwrite'; // simple endpoints
