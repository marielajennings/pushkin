...
module.exports = class Handler {
	constructor() {
		...
		this.tables = {
			users: 'jspsych5_users',
			stim: 'jspsych5_stimuli',
			stimResp: 'jspsych5_stimulusResponses',
			stimGroups: 'jspsych5_stimulusGroups',
			stimGroupStim: 'jspsych5_stimulusGroupStimuli',
			TUQ: 'jspsych5_TUQ',
			TUQSR: 'jspsych5_TUQSR',
		};
