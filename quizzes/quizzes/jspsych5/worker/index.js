...
const READ_QUEUE = 'jspsych5_quiz_dbread';
const WRITE_QUEUE = 'jspsych5_quiz_dbwrite';
const TASK_QUEUE = 'jspsych5_quiz_taskworker'; // eventually this should be moved to a separate thing
