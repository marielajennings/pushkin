...
export default class jspsych5 extends React.Component {
	...
	loadJsPsych() {
		...
		const jsPsychMainScript = 'http://localhost/jspsych.js';
		// these are all required by something in either jspTimeline or meta/stim stuff sent from the api
		const jsPsychPlugins = [
			'https://cdn.jsdelivr.net/gh/jspsych/jsPsych@5.0.3/plugins/jspsych-text.js'
